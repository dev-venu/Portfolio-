import { RiCloseLine, RiMenu2Fill } from "@remixicon/react";
...
const Navbar = () => {
  ...
  return (
   ...
   <nav className="flex flex-wrap justify-between md:items-center text-white px-10 pt-6 md:px-20">
     ...
     text-center md:bg-transparent md:static md:mx-0 md:flex gap-5 `}>
      ...
      {showMenu ? (
           <RiMenu2Fill size={30} className="md:hidden absolute right-10 top-6 transition-all duration-300"
